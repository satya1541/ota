...
>(({ className, ...props }, ref) => (
  <tr
    ref={ref}
    className={cn(
      "transition-colors hover:bg-white/5 data-[state=selected]:bg-muted/50 group bg-black/20 shadow-sm rounded-lg border border-transparent hover:border-white/5",
      className
    )}
    {...props}
  />
