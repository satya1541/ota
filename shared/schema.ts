...
export const users = mysqlTable("users", {
  ...
  email: varchar("email", { length: 255 }).unique(), // Optional now
  username: varchar("username", { length: 255 }), // Optional now, removed unique and notNull
  password: text("password"), // Optional now
  pin: varchar("pin", { length: 64 }).notNull(), // 4-digit PIN (hashed), required
  resetToken: varchar("reset_token", { length: 64 }), // For password reset
